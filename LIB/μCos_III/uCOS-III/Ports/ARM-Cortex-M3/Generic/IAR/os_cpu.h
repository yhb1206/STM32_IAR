...
#if 1
void  PendSV_Handler (void);/*os_cpu.h和os_cpu_a.asm中的OS_CPU_PendSVHandler为PendSV_Handler*/
void  SysTick_Handler(void);/*os_cpu.h和os_cpu_c.c中的OS_CPU_SysTickHandler为SysTick_Handler*/
#else
void  OS_CPU_PendSVHandler (void);/*os_cpu.h和os_cpu_a.asm中的OS_CPU_PendSVHandler为PendSV_Handler*/
void  OS_CPU_SysTickHandler(void);/*os_cpu.h和os_cpu_c.c中的OS_CPU_SysTickHandler为SysTick_Handler*/
#endif
