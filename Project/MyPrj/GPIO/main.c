...
*PURPOSE: 
*LAST MODIFY DATE: 
*REMARK: 本例程是针对秉火F103霸道开发板，

****************************************************************************/
/*GPIO相关例程*/
#define  GPIO_OUT_DEMO          (0)/*GPIO输出例程*/
#define  GPIO_IN_DEMO           (1)/*GPIO输入例程*/
#define  GPIO_BIT_BAND_DEMO     (2)/*GPIO的位带操作例程*/
...
/*F103霸道开发板上的RGB灯的通用配置*/
#define COM_LED_PORT        GPIOB
#define COM_LED_CLK         RCC_APB2Periph_GPIOB

/*F103霸道开发板上的RED灯配置*/
#define RED_LED_PORT        GPIOB
#define RED_LED_PIN         GPIO_Pin_5
#define RED_LED_CLK         RCC_APB2Periph_GPIOB
#define RED_LED_ON          RCC_APB2Periph_GPIOB
#define RED_LED_OFF         RCC_APB2Periph_GPIOB

/*F103霸道开发板上的GREEN灯配置*/
#define GREEN_LED_PORT      GPIOB
#define GREEN_LED_PIN       GPIO_Pin_0
#define GREEN_LED_CLK       RCC_APB2Periph_GPIOB


/*F103霸道开发板上的BLUE灯配置*/
#define BLUE_LED_PORT       GPIOB
#define BLUE_LED_PIN        GPIO_Pin_1
#define BLUE_LED_CLK        RCC_APB2Periph_GPIOB


void Delay(__IO u32 nCount); 
void Yhb_Led_Config(void);
...
void Yhb_Led_Config(void)
{
    ...
    /*开启LED相关的GPIO外设时钟*/
    RCC_APB2PeriphClockCmd(COM_LED_CLK, ENABLE);
    
    /*调用库函数，初始化GPIO*/
    GPIO_Init(COM_LED_PORT, &GPIO_InitStructure);  
